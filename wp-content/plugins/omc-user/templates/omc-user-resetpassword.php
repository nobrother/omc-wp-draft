...
<div id="main-content" class="main-content">
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">
			...
			<?php echo apply_filters( 'omc_user_reset_password_messages', isset( $_GET[ 'message' ] ) ? $_GET[ 'message' ] : '' ); ?>

			<form action="<?php echo OMC_User::get_action_url( 'reset_password' ); ?>" method="post">
				<?php wp_nonce_field( 'reset_password', 'wp_uf_nonce_reset_password' ); ?>
				<input type="hidden" name="user_key" id="user_key" value="<?php echo isset( $_GET[ 'key' ] ) ? $_GET[ 'key' ] : ''; ?>">
				<p>
