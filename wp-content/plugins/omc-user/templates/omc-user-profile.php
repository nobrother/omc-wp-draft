...
<div id="main-content" class="main-content">
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">
			...
			<?php echo apply_filters( 'omc_user_profile_messages', isset( $_GET[ 'message' ] ) ? $_GET[ 'message' ] : '' ); ?>
			
			<div><a href="<?php echo wp_logout_url(); ?>" title="Logout">Logout</a></div>

			<form action="<?php echo OMC_User::get_action_url( 'profile' ); ?>" method="post" <?php do_action( 'user_edit_form_tag' ); ?>>
				<?php wp_nonce_field( 'profile' ); ?>
