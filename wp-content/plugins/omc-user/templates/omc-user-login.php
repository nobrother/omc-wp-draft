...
<div id="main-content" class="main-content">
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">
			...
			<?php echo apply_filters( 'omc_user_login_messages', isset( $_GET[ 'message' ] ) ? $_GET[ 'message' ] : '' ); ?>

			<form action="<?php echo OMC_User::get_action_url( 'login' ); ?>" method="post">
				<?php echo apply_filters( 'login_form_top', '', OMC_User::login_form_args() ); ?>
				...
				<?php echo apply_filters( 'login_form_middle', '', OMC_User::login_form_args() ); ?>
				<p>
				...
				<?php echo apply_filters( 'login_form_bottom', '', OMC_User::login_form_args() ); ?>
			</form>
		</div>
	</div>
</div>
