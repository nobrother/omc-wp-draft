...
abstract class ExportData {
	 ...
	 */
	public function exceldate( $datetime ){
		return 25569 + $datetime / 86400 ;
	} 
}
...
class ExportDataExcel extends ExportData {
	...
	function generateHeader() {
		...
		// Set up styles
		$output .= "<Styles>\n";
		$output .= "<Style ss:ID=\"sDT\"><NumberFormat ss:Format=\"dd mmm yyyy\"/></Style>\n";
		$output .= "</Styles>\n";
	...
	private function generateCell($item) {
		...
		// Treat leading zero number as string
